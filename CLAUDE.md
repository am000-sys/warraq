...
- **تصحيح الآيات القرآنيّة:** `src/lib/quran-correct.ts` يصحّح الآيات المقتبسة بين قوسي
  ...
  - **مصدر النصّ:** `src/data/quran-uthmani.json` (الرسم العثمانيّ، رواية حفص — مولّد من
    مصدر منشور وموثّق داخل الملفّ). **قابل للاستبدال** بملفّ مجمع الملك فهد الرسميّ بنفس
