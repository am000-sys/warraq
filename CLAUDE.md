...
> **الحالة الراهنة:** الميزة **مفتوحة** على مزوّد **Kimi (Moonshot)** بنموذج
> `kimi-k3`، بعد تعطّل مسار Qwen. تُفتح تلقائيّاً متى توفّر مفتاح المزوّد
> (`MOONSHOT_API_KEY`)، وتُغلق يدويّاً بـ `STUDY_ENABLED="0"`.
>
