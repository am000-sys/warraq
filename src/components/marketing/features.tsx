...
const feats = [
  ...
  },
  {
    icon: "⚡",
    t: "معالجة سريعة",
    d: "معالجة الصفحات في ثوانٍ، مع تشغيل متوازٍ للكتب الضخمة دون انتظار.",
  },
  {
    icon: "◈",
    t: "ثلاثة نماذج",
    d: "سريع للنصوص الواضحة، متوازن للأغلب، ودقيق لأصعب المخطوطات. اختر الأنسب لك.",
  },
  {
    icon: "↓",
    t: "تصدير متعدد الصيغ",
  ...
  },
  {
    icon: "#",
    t: "حفظ ترقيم الصفحات",
    d: "نحفظ رقم الصفحة المطبوع داخل النصّ — مرجعيّة دقيقة للمحقّقين والباحثين.",
  },
  {
    icon: "⊞",
    t: "حسابات المؤسسات",
