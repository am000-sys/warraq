...
export function StudyClient({ jobs, initialSummaries, balance, isAdmin, pricing }: Props) {
  ...
  function markQueued(id: string) {
    ...
    setViewer(null);
    setNotice(
      "المهمّة قيد المعالجة على الخادم وتُبنى على مقاطع متتابعة. يمكنك إغلاق الصفحة بأمان: تمضي المعالجة وحدها وتصلك رسالة بريديّة عند الاكتمال، ويظهر الملخّص هنا تلقائياً إن بقيت.",
    );
  }
